...
def readSetting(csv_path):
    ...
    with open(csv_path, 'r') as csv_file:
        ...
        for line in csv_reader:
            csv_dict[line[0]] = {
            'snapshot_active':str_to_bool(line[1]),
            'snapshot_period':float(line[2]),
            'film_active':str_to_bool(line[3])}  
    print(csv_dict, 'readS')
    return csv_dict
